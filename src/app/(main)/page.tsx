            ...
            <Container className='relative z-10'>
              <div className='flex flex-col lg:flex-row items-center min-h-[calc(100vh-120px)] gap-16'>
                ...
                <div className='flex-1 text-center lg:text-left'>
                  ...
                  <Link 
                    href='/courses' 
                      className='inline-flex items-center gap-3 px-8 py-4 bg-primary hover:bg-primary-focus text-primary-content font-semibold text-lg rounded-full transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-lg'
                  >
                    Get Started
